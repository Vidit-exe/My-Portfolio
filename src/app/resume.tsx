    ...
    <section className="px-8 py-24">
      <div className="container mx-auto grid w-full grid-cols-1 items-center gap-16 lg:grid-cols-2">
        <div className="col-span-1">
          <Typography variant="h2" classname="dark:bg-white dark:text-gray-900">
            My Resume
          </Typography>
          <Typography className="mb-4 mt-3 w-9/12 font-normal dark:text-white">
          ...
          <Button
            variant="text"
            color="gray"
            className="flex items-center gap-2 bg-gray-900 text-white dark:bg-white dark:text-gray-900"
          >
            Download Now
            <ArrowDownIcon
              strokeWidth={3}
